...
PROMPTS = {
    "hero": {
        ...
        "prompt": (
            ...
            "Do not stage them as a portrait and do not have them look at the camera. "
            "All four people must be actively working: cooking, plating, serving, reaching for buns, turning food on the griddle, or prepping toppings. "
            "Use candid working gestures and natural focus on the food and the service, not direct eye contact with the viewer. "
